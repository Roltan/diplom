...
<div class="modalka modalka--wrapper" id="resetPasswordModal" style="display: flex">
    <form class="form--login form" id="resetPassword">
        ...
        <div class="input">
            ...
            <input type="password" name="password" id="password_reset" class="input--field" />
        </div>
        <div class="input">
            <label for="password_confirmation_reset">Повторите пароль</label>
            <input type="password" name="password_confirmation" id="password_confirmation_reset" class="input--field" />
        </div>
