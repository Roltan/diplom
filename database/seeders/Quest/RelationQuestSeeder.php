    ...
    public function run(): void
    {
        DB::table('relation_quests')->insert([
            ...
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите графики функций с их производными',
                'first_column' => json_encode([
                    'Парабола (y = x²)',
                ...
                'second_column' => json_encode([
                    'Прямая с положительным наклоном (2x)',
                    'Парабола с минимумом в нуле (3x²)',
                    'Косинусоида (cos(x))',
                    'Экспонента (e^x)',
                    'Отрицательная гипербола (-1/x²)'
                ]),
                'difficulty' => 70,
            ],
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите экономические термины с их производственными аналогами',
                'first_column' => json_encode([
                    'Предельная выручка',
                    'Эластичность спроса',
                ...
                'second_column' => json_encode([
                    ...
                    'Процентное изменение спроса / процентное изменение цены',
                    'R(x) = C(x)',
                    'Вторая производная < 0',
                    'Уравнение U(x,y) = const'
                ]),
                'difficulty' => 80,
            ],
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите физические законы с их дифференциальной формой',
                'first_column' => json_encode([
            ...
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите методы оптимизации с их применением',
                'first_column' => json_encode([
                ...
                'second_column' => json_encode([
                    'Минимизация ошибки регрессии',
                    'Оптимизация с линейными ограничениями',
                    'Поиск минимума нейросетевой функции потерь',
                    'Учет ограничений через множители',
                    'Численный анализ негладких функций'
                ]),
                'difficulty' => 75,
            ],
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите математические парадоксы с их разрешением',
                'first_column' => json_encode([
                ...
                'second_column' => json_encode([
                    'Не существует по теореме Дарбу',
                    'Нигде не дифференцируема',
                    'Почти везде нулевая производная',
                    'Учёт условий сходимости рядов',
            ...
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите биологические модели с уравнениями',
                'first_column' => json_encode([
                    'Рост бактерий',
                    'Хемотаксис',
                    'Нейронный потенциал',
            ...
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите типы дифференциальных уравнений с примерами',
                'first_column' => json_encode([
                    'Обыкновенное (ODE)',
                    'Уравнение в частных производных (PDE)',
                    'Стохастическое',
                    'Интегро-дифференциальное',
                    'Алгебраико-дифференциальное'
                ]),
                'second_column' => json_encode([
                    'dy/dx = x² + y',
                    '∂u/∂t = α∇²u',
            ...
            [
                ...
                'second_column' => json_encode([
                    'Решение уравнений с начальными условиями',
                    'Единство производной и интеграла',
                    'Минимизация параметров модели',
                    'Невозможность точного измерения пары переменных',
                    'Свойства системы ≠ сумме свойств элементов'
                ]),
                'difficulty' => 95,
            ],
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите алгоритмы с их использованием производных',
                'first_column' => json_encode([
                ...
                'second_column' => json_encode([
                    'Цепное правило для нейросетей',
                    'Итерации с использованием второй производной',
                    'Гибрид градиентного спуска и Гаусса-Ньютона',
                    'Обновление весов на подвыборках данных',
            ...
            [
                'topic_id' => 2,
                'vis' => 1,
                'quest' => 'Соотнесите исторические открытия с учёными',
                'first_column' => json_encode([
